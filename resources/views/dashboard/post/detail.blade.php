            ...
            <div class="row justify-content-center my-1">
                <div class="col-lg-10">
                    ...
                    <img src=" https://source.unsplash.com/1200x600?{{ $post->category->name }}"
                        class="card-img-top" style="border-radius: 20px" alt="{{ $post->category->name }}">
                    @endif
                    ...
                    <div class="group-button mt-5 mb-5 d-inline">
                        <a href="/dashboard/post" class="btn btn-success px-3"><i
                                class="fas fa-long-arrow-alt-left"></i> Back to My post</a>
                        <a href="/dashboard/post/{{ $post->slug }}/edit" class="btn btn-primary"><i
                                class="fas fa-edit"></i>
                            Edit</a>
